...
Exp=$(curl -sS https://raw.githubusercontent.com/jalgitap/mpek/main/REG/ipvps | grep $MYIP | awk '{print $3}')
fi
chck_b(){
	PID=`ps -ef |grep -v grep | grep aNzVPN_bot |awk '{print $2}'`
	if [[ ! -z "${PID}" ]]; then
...
curl -sS https://raw.githubusercontent.com/jalgitap/mpek/main/clgshow
echo -e "
"
fi
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
