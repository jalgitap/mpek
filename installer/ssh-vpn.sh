...
curl -sS https://raw.githubusercontent.com/jalgitap/mpek/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:aNzVPN07gg -pbkdf2 > /etc/pam.d/common-password
...
# set time GMT +08
sleep 1
echo -e "[ ${green}INFO$NC ] Set zona local time to Asia/Kuala_Lumpur GMT+08"
...
# install squid
cd
curl -sS "https://raw.githubusercontent.com/jalgitap/mpek/main/ssh/squid3.conf" | openssl aes-256-cbc -d -a -pass pass:aNzVPN07gg -pbkdf2 > /etc/squid/squid.conf
