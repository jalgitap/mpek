...
commonname=None
email=github@anzclan

# simple password minimal
curl -sS https://raw.githubusercontent.com/jalgitap/mpek/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
# set time GMT +08
sleep 1
echo -e "[ ${green}INFO$NC ] Set zone local time to Asia/Kuala_Lumpur GMT+8"
...
echo "telegram.com/aNzVPN" > /home/vps/public_html/index.html
# install badvpn
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/jalgitap/mpek/main/ssh/newudpgw"
...
# install squid
cd
curl -sS "https://raw.githubusercontent.com/jalgitap/mpek/main/ssh/squid3.conf" | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/squid/squid.conf
...
wget -q https://raw.githubusercontent.com/jalgitap/mpek/main/ssh/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/jalgitap/mpek/main/banner/issue.net"
chmod +x /etc/issue.net
echo "Banner /etc/issue.net" >> /etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear
cat> /etc/issue.net << END
<font color="red"><b>============================</b></font><br> 
<font color="white"><b>         DOTYVPN         </b></font><br> 
...
echo 'ctechdidik.me' > /root/.ctech/.kumbang/digi
echo 'ctechdidik.me' > /root/.ctech/.kumbang/umobile
echo 'ctechdidik.me' > /root/.ctech/.kumbang/maxis
echo 'ctechdidik.me' > /root/.ctech/.kumbang/unifi
echo 'ctechdidik.me' > /root/.ctech/.kumbang/yodoo
echo 'ctechdidik.me' > /root/.ctech/.kumbang/celcom
echo 'done' > /root/.ctech/.kumbang/install
