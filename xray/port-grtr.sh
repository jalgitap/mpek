...
clear
prtt="$(cat /root/log-install.txt | grep -w "XRAY  Trojan Grpc" | cut -d: -f2|sed 's/ //g')"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "\E[44;1;39m     ⇱ Change Port Trojan Grpc ⇲   \E[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "      Change Port $prtt"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
read -p "New Port Trojan Grpc: " prtt2
if [ -z $prtt2 ]; then
echo "Please Input Port"
exit 0
fi
cek=$(netstat -nutlp | grep -w $prtt2)
sed -i "s/: $prtt/: $prtt2/g" /etc/xray/trojangrpc.json
sed -i "s/   - XRAY  Trojan Grpc        : $prtt/   - XRAY  Trojan Grpc        : $prtt2/g" /root/log-install.txt
